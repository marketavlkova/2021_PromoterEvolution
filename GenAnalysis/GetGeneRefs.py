### Script to search for and extract genes
### from MG1655 genome according to a given RegulonDB TSS database
### example to run: python3 GetGeneRefs.py <path to filtered RegulonDB csv file> <path to MG1655 genome file (GenBank)> [confidence level - optional]
...
def main():
    ...
    if os.path.isfile('output/' + '{}_{}_PromAnnots.csv'.format(db_name, confidence)):
        feats_fin = {}
        with open('output/' + '{}_{}_PromAnnots.csv'.format(db_name, confidence)) as in_file:
